...
ALLOWED_HOSTS = ['my-empty-seed-project.herokuapp.com', 'my-empty-seed-project-be.herokuapp.com/']
...
CORS_ORIGIN_WHITELIST = (
    'my-empty-seed-project.herokuapp.com',
    'my-empty-seed-project-be.herokuapp.com/'
)
